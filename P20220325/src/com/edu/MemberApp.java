...
public class MemberApp {
	...
	public MemberApp() {
		members.add(new BookMember(101, "아무개", "010-1111-6785", "강경한", "동구"));
		members.add(new BookMember(102, "감자바", "010-4567-2563", "김준수", "북구"));
		members.add(new SoccerMember(103, "김말자", "010-1179-2356", "최정련", "A"));
		members.add(new SoccerMember(104, "강경한", "010-5212-8879", "한숙련", "C"));
		members.add(new SwimMember(105, "박인경", "010-2222-3333", "강일경", "B등급"));
		members.add(new SwimMember(106, "권가희", "010-1235-5421", "강일경", "A등급"));
	}
